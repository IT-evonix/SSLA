...
<main class="courses_list_mainbox">
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">English</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                <div class="subject_listing_heading">English Romanticism</div>
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-1.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Victorian Literature</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-2.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Indian Writing in English</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-3.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Linguistics and Phonetics</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-4.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">20th Century Literature</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-5.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Reading Popular Literature</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-6.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">History of Literary Criticism</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-7.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Shakespeare and his Times</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-8.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Literary Criticism 2</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-9.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Postcolonial Literatures (Africa and Latin America)</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-10.svg') }}"
                                            alt="Corporate Governance and Ethics icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                <div class="subject_listing_heading">American Literature</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/english-course-11.svg') }}"
                                            alt="Corporate Governance and Ethics icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
