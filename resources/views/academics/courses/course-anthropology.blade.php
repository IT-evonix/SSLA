...
<main class="courses_list_mainbox">
    ...
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">Anthropology</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        <div class="new_course_listing_para">
                            <p>
                                Anthropology as a Major Discipline provides a comprehensive and holistic study of
                                humankind by integrating biological, socio-cultural, archaeological, and applied
                                perspectives. The curriculum enables students to examine human evolution, biological
                                variation, cultural systems, social institutions, economies, power structures, and
                                material culture across time and space. Emphasis is placed on anthropological theory,
                                ethnographic and archaeological research methods, and interdisciplinary analytical
                                skills. Students are trained to critically engage with issues of identity, inequality,
                                adaptation, and cultural change within diverse ecological and historical contexts. The
                                programme further highlights the practical applications of anthropology in development,
                                health, heritage, business, and governance, preparing students for research-oriented and
                                socially responsive careers.
                            </p>
                        </div>
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                <div class="subject_listing_heading">What is Anthropology?</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            What is Anthropology? introduces students to the study of humans, their
                                            societies, cultures, and evolution. Covering the five sub-disciplines of
                                            anthropology, the course explores human adaptability, social structures,
                                            economies, political systems, and cultural processes. Students learn
                                            research methods, including ethnography and participant observation, and
                                            examine applied anthropology. Through discussions, multimedia resources, and
                                            projects, the course develops analytical, observational, and research
                                            skills, providing a comprehensive understanding of human behavior, cultural
                                            variation, and societal dynamics across diverse historical, geographical,
                                            and ecological contexts.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-1.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Biological Anthropology</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            Biological Anthropology introduces students to the scientific study of human
                                            biological evolution and variation. The course traces the historical
                                            development of evolutionary thought, from Darwin and Mendelian genetics to
                                            the modern evolutionary synthesis, and examines major theories explaining
                                            human evolution. It also explores human biological diversity, critically
                                            engaging with concepts of race, genetics, and biocultural evolution.
                                            Emphasis is placed on understanding the scope and applications of biological
                                            anthropology in addressing contemporary human issues. Through interactive
                                            discussions, case studies, audiovisual resources, and engagement with
                                            research literature, the course develops analytical skills and a
                                            comprehensive understanding of humanity’s biological past and present.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-2.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Socio-Cultural Anthropology 1</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            Socio-Cultural Anthropology I introduces students to the holistic study of
                                            human societies and cultures, emphasizing diversity, interdependence, and
                                            adaptation. The course traces the evolution of anthropological thought and
                                            familiarizes students with key theories such as evolutionism, diffusionism,
                                            functionalism, cultural ecology, and globalization. It explores language,
                                            religion, art, media, ethnicity, race, and gender as central dimensions of
                                            social life. By engaging with societies different from their own, students
                                            develop cultural sensitivity and critical perspectives on contemporary
                                            global issues. Through interactive discussions, ethnographic insights, and
                                            applied projects, the course fosters analytical thinking and problem-solving
                                            skills relevant to real-world contexts.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-3.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Socio-Cultural Anthropology 2</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            The Advance Social Psychology course provides students with a comprehensive
                                            understanding of social psychological theories, principles, and human
                                            behavior. It emphasizes self-concept, social cognition, cultural diversity,
                                            persuasion, prejudice, aggression, conflict, and relationships. Students
                                            learn to critically analyze research and apply social psychology to
                                            real-world situations, including sustainability and social influence. The
                                            curriculum integrates theoretical knowledge with experiential activities,
                                            research papers, guest lectures, and lab work. Through Socratic teaching,
                                            class discussions, and practical exercises, learners develop analytical
                                            skills and an ability to interpret human behavior across diverse contexts.
                                            The course prepares students to apply psychological insights effectively in
                                            everyday life and research settings.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-4.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Anthropology Today: Its Application
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            Anthropology Today: Its Application explores the practical relevance of
                                            anthropology in contemporary society, business, and governance. The course
                                            traces the historical development of applied anthropology and examines its
                                            expanding role across biological, bio-cultural, social, and cultural
                                            domains. Students engage with applications in health, nutrition, public
                                            policy, forensic science, education, media, urban planning, business, and
                                            technology. Through case studies, fieldwork, interaction with industry
                                            practitioners, and research-based learning, the course builds analytical and
                                            critical reasoning skills. Emphasis is placed on identifying real-world
                                            problems, conducting applied research, and using anthropological insights to
                                            address social challenges and benefit global society.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-7.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Introduction to Archaeology: Theory and Techniques
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            Introduction to Archaeology: Theory and Techniques course provides students
                                            with a comprehensive understanding of archaeology as both a scientific and
                                            social science discipline. It explores the historical development of
                                            archaeology, excavation methods, site identification, and analysis of
                                            artefacts. Students learn to apply interdisciplinary techniques from
                                            anthropology, earth sciences, and social sciences to interpret
                                            archaeological data. The course emphasizes understanding cultural identity,
                                            ancient economies, politics, and technology through material remains. Field
                                            visits to excavation sites enhance practical skills, while discussions, case
                                            studies, and audiovisual materials foster critical thinking, analytical
                                            abilities, and an appreciation of archaeology’s scientific and cultural
                                            significance.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-5.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Anthropology-icon-6.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/global-research.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/employee-alt.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                            This course offers a critical sociological understanding of globalization as
                                            a complex and contested process shaping contemporary society. It examines
                                            the historical evolution and multiple dimensions of globalization—economic,
                                            cultural, social, and ecological—while engaging with key theoretical
                                            perspectives. Emphasis is placed on the relationship between knowledge and
                                            power, the crisis of globalization, and its unequal impacts on marginalized
                                            communities. Through themes such as gender, migration, environmental
                                            challenges, and resistance movements, students develop analytical skills to
                                            evaluate globalization’s consequences and explore alternative futures in an
                                            interconnected global society.
                                        </p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/languages-world.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/house-building.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/microscope-bacteria.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/megaphone-sound-waves.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/search-alt.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/group-community-social-media.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">The History of Anthropological Theory and Changing
                                    Ethnography</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/order-history.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/cdn.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/hammer-war.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">World Music: Crossroads of Space, Place and
                                    Identity</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/folder-music.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Anthropology of Globalization, Development and
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/career-growth.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Identity, Ethnicity, Nationality, and
                                    Fundamentalism</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/id-card-clip-alt.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/fireplace.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/analyse.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Revisiting the City: Urbanization, Urban Aspiration
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/car-building.svg') }}"
                                            alt="Courses icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">The Illbeing - Disease, Health and Socio-politics
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Urban Studies: Cross-Disciplinary Perspectives
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
