...
<main class="courses_list_mainbox">
    ...
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">Semester Six</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Short Stories from around the World</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">Short Stories from around the World offers students an in-depth
                                            engagement with short fiction from diverse literary traditions and cultural
                                            contexts. The course examines selected stories by various writers to
                                            understand the genre’s distinctive features, narrative techniques, tone, and
                                            use of language. Emphasis is placed on reading texts within their social,
                                            political, and historical contexts while engaging with relevant literary
                                            theories and critical debates. Students actively discuss and compare texts,
                                            explore film adaptations of selected stories, and develop informed
                                            interpretations. Through close reading, discussion, and essay writing, the
                                            course strengthens critical thinking, comparative analysis, and expressive
                                            skills in literary studies.</p>
                                    </div>
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/semester-six-1.svg') }}"
