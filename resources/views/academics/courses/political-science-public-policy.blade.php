                ...
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Political Process and Dynamics of State Politics in India</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Introduction to Public Administration and Public Policy
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
