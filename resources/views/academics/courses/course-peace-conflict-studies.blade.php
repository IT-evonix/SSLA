...
<main class="courses_list_mainbox">
    ...
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">Peace & Conflict Studies</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Introduction to Violence, Conflict and Peace Studies</div>
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/peace-conflict-1.svg') }}"
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/peace-conflict-3.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Shifting Homelands: Ideology, Migration and Conflict
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/peace-conflict-4.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Gender and Law 
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/peace-conflict-5.svg') }}"
                            ...
                            <div class="subject_listing">
                             ...
                             <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/peace-conflict-7.svg') }}"
                                            alt="Practical Creation icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
