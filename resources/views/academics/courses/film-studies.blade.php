...
<main class="courses_list_mainbox">
    ...
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">Film Studies</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Silent Cinema</div>
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/film-studies-1.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Realism and Cinema</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">The Cinematic Apparatus</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/film-studies-2.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Narrative Cinema
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/film-studies-3.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Documentary Cinema or Non-Fiction
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/film-studies-4.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Global Cinema Today</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/film-studies-5.svg') }}"
