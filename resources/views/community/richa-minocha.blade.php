        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="section-card" data-aos="fade-up">
                        ...
                        <ol class="ps-3">
                            <li>Richa (2008). Environment, Agriculture and Community in Himachal Pradesh, Himalaya Publishing House, Mumbai. ISBN: 978-81-8488-134-9.</li>
                        </ol>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="section-card" data-aos="fade-up">
                        ...
                        <ul>
                           <li>Post-Doctoral Fellowship: C.R. Parekh Fellow (2008–2009) at the London School of Economics and Political Science</li>

                                    <li>PhD and MPhil in Social Sciences and Development Studies from the Centre for the Study of Regional Development, Jawaharlal Nehru University (JNU), New Delhi</li>

                                    <li>Master's in Tourism Administration from Himachal Pradesh University, Simla</li>

                                    <li>B.A. Pass Course in Economics, Mathematics, English, and Hindi from Saint Bede’s College, Simla, Himachal Pradesh</li>

                                    <li>Qualified University Grants Commission - National Educational Testing (NET) in Economics</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card" data-aos="fade-up">
                ...
                <ul class="research-list">
                    <li>Food Security in the Pune Development Area: Implications and Impacts of Commercialisation, Improper Waste Management, Urbanisation, and Industrialisation, Research Project under Politics of Ecology Course (2019).</li>

                      <li>ICSSR-sponsored project: “Development at What Cost! A Study of Migration, Loss of Livelihood Security and Development-Induced Resettlement in Himachal Pradesh”. Analysis based on the premise that the impacts of development projects are not gender neutral (2011–2012).</li>
                </ul>
            </div>
            <!-- AWARDS -->
            <!-- <div class="section-card" data-aos="fade-up">
