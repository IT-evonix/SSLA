    ...
    <section class="faculty_details_section">
        <div class="container">
                ...
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-lg-4 text-center">
                        <div class="profile-img-wrapper">
                            ...
                            <img src="{{ asset('/assets/images/about/Shweta-Sinha.webp') }}" alt="Dr. Manoranjan Ghosh"
                    ...
                    <div class="col-lg-8">
                        <div class="ms-3">
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <p class="faculty-email-label d-flex align-items-center">
                                            ...
                                            <a href="mailto:director@ssla.edu.in " class="text-decoration-none">
                            ...
                            <div class="teaching-philosophy">
                                ...
                                <p>
                                    “There is always more than one side to a story, and more than one answer to a
                                    question.”

                                    As an educator, Shweta brings archaeology and anthropology into dialogue with lived
                                    experience. Her classrooms are spaces where students are encouraged to question
                                    disciplinary boundaries, recognise positionality, and engage critically with the
                                    world around them.
            ...
            <div class="section-card" data-aos="fade-up">
                ...
                <p>Archaeology, Culture, and the Liberal Arts as a Way of Thinking</p>
                <p>
                    For Dr. Shweta Sinha Deshpande, archaeology has never been merely about the past. It has been a way
                    of understanding how humans remember, belong, migrate, believe, and imagine themselves across time
                    and space. Her work moves fluidly between ancient landscapes and contemporary societies, between
                    material culture and living communities, and between the field and the classroom. What anchors this
                    movement is a commitment to understanding how cultures are forged, sustained, and transformed. </p>
                <p>
                    Trained as an archaeologist, her academic journey began with the material traces of South Asian
                    protohistory. Her doctoral work at Deccan College focused on cultural interactions in Central and
                    Western India during the third and second millennia BCE, an inquiry, that refuses to treat cultures
                    as isolated or static. Instead, her work approaches them as relational, dynamic, and interconnected,
                    shaped by networks of exchange, technology, belief, and movement. Her engagement with archaeology
                    has always gone beyond excavation; she has been deeply invested in how archaeological knowledge is
                    produced, framed, and mobilised, how narratives gain authority, and how the past is appropriated in
                    the present. Her work has contributed significantly to rethinking Chalcolithic South Asia,
                    particularly in terms of crafts, technologies, interaction networks, and regional trajectories. </p>

                <p>
                    Over time, this sensitivity to interaction expanded beyond protohistoric societies to include
                    contemporary questions of globalization, migration, religion, education, and identity. Whether
                    examining Chalcolithic technologies or present-day religious iconography, her work consistently
                    asks: what cultural baggage do people carry, often unconsciously, and how does it shape the worlds
                    they inhabit? </p>

                <p>
                    One of her significant pedagogical contributions has been the development of the CBALwRAS model
                    (Curriculum-Based Academic Learning with Research, Action, and Service), a framework that integrates
                    curriculum, community partnership, and research for social impact. This model reflects her belief
                    that education must be embedded in social realities and that knowledge-making carries
                    responsibility. </p>

                <p>
                    Currently serving as the Director and Associate Professor at the Symbiosis School for Liberal Arts
                    (SSLA), Shweta has a long and formative engagement with Liberal Arts education since 2008. Over the
                    years, she has played a central role in shaping SSLA’s academic vision, curriculum design, community
                    engagement, and internationalisation. </p>

                <p>
                    She is engaged in teaching courses across archaeology, anthropology, migration studies, history,
                    along with interdisciplinary courses. </p>
            </div>
            <!-- achievement -->
            <!-- <div class="section-card" data-aos="fade-up">
                <div class="section-header">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <div class="section-card" data-aos="fade-up">
                        ...
                        <ol class="ps-3 publication-list">
                            <li>
                                2016 Chalcolithic South Asia: Aspects of Crafts and Technologies (Indus Infinity
                                Foundation Series: Contribution to History of Indian Science and Technology) (with
                                Vasant Shinde and Amrita Sarkar), Pentagon Press ISBN 13: 9788182749085
                            </li>

                            <li>
                                2011 Gazetteer of Indian Archaeological and Historical Sites: Vol. 1, Gujarat, (with
                                V.S. Shinde) Aryan International Publishers ISBN 978-81-7305-413-6
                            </li>

                            <li>
                                2025 An Accidental Deity: A New Religious Icon for the Modern Age in Social Evolution &
                                History, Volume 24, NUMBER 1 / MARCH 2025. (with Atiya Fatima and Afshan Majid)
                                DOI:
                                <a href="https://doi.org/10.30884/seh/2025.01.00" target="_blank" class="text-danger">
                                    https://doi.org/10.30884/seh/2025.01.00
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                <a href="https://www.sciencedirect.com/science/article/abs/pii/S2352226724000394klo"
                                    target="_blank" class="text-danger">
                                    (https://www.sciencedirect.com/science/article/pii/S2352226724000394)
                                </a>
                            </li>

                            <li>
                                2024 Curriculum and Community with Research, Action, and Service (CCBALwRAS), a
                                Pedagogical Shift for Social Change submitted to Higher Education for the Future (with
                                Dr. Sulakshana Sen, Ms. Gayatri Mendanha and others).
                                <a href="https://doi.org/10.1177/23476311231210636" target="_blank" class="text-danger">
                            ...
                            <li>
                                2015, Craft and Technologies of the Chalcolithic People of South Asia: An Overview.
                                Indian Journal of History of Science, 50.1, 42-54 (with V.S. Shinde)
                            </li>

                            <li>
                                2014, The Deccan Chalcolithic, in Dilip K. Chakrabarti and Makkhan Lal Edt. History of
                                Ancient India, Volume II Protohistoric Foundations. (with V.S. Shinde and Others)
                                Vivekananda International & Foundation Aryan Books International pp 487-497 ISBN-10
                                8173054819
                            </li>
                        </ol>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="section-card" data-aos="fade-up">
                        ...
                        <ul>
                            <li>
                                Ph.D. 2003. “A Study of Cultural Interactions in Central and Western India during the
                                Third & Second Millennia BC”, Deccan College Post-Graduate and Research Institute, Pune
                            </li>
                            ...
                            <li>
                                M.A. 1996-98, Ancient Indian History, Culture & Archaeology with Dissertation Study of
                                Chalcolithic Social Organization in Central India with special reference to Balathal,
            ...
            <div class="section-card" data-aos="fade-up">
                ...
                <ul class="research-list">
                    <li>Archaeology, Education, Globalisation, Migration, Religion</li>
