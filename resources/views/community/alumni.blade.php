            ...
            <div class="alumni-main-section mt-5">
                ...
                <div class="row mb-5">
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="main-class-alumini-img">
                            <div class="alumni-image">
                                <img src="{{ asset('/assets/images/community/alsi9.webp') }}" alt="Ira Chakraborty"
                                    class="img-fluid">
                            </div>
            ...
            <div class="alumni-main-section mt-5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="main-class-alumini-img">
                            <div class="alumni-image">
                                <img src="{{ asset('/assets/images/community/alsi151.webp') }}" alt="Ira Chakraborty"
                                    class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="main-class-alumini-img">
                            <div class="alumni-image">
                                <img src="{{ asset('/assets/images/community/alsi161.webp') }}" alt="Ira Chakraborty"
                                    class="img-fluid">
                            </div>
                            <h3>Isha Mathur</h3>
                            <p class="batch-txtt">Test Batch</p>
