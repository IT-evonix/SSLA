            ...
            <div class="row mb-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="section-card" data-aos="fade-up">
                        ...
                        <ul>
                          <li>Ph.D. in Climate and Development, Indian Institute of Technology, Kharagpur, 2017-2021.</li>
                          <li>M.A. in Geography, Specialising in Climate Change, University of Burdwan, 2013-2015.</li>
                          <li>B.Ed. in Educational Psychology, Himachal Pradesh University, 2013.</li>
                          <li>B.A. in Geography (Honours), Birpara College, University of North Bengal, 2009-2012. </li>
                        </ul>
                    </div>
                </div>
            </div>
...
Livelihoods, Natural Resource Uses, Climate Resilience and Development Practices, GIS and Research 
Methods, and Social and Environmental Data Analysis. </li>
            ...
            <div class="section-card" data-aos="fade-up">
                ...
                <ul>
                    <li>Research Methodology: Philosophy, Methods, and Analysis.</li>
