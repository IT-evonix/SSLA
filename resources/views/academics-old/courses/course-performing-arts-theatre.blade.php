...
<main class="courses_list_mainbox">
    ...
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">Performing Arts Theatre</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Introduction to Theatre Making</div>
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/performing-arts-theatre-1.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Voice and Speech</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/performing-arts-theatre-2.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Text Analysis and Playwriting Lab</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/performing-arts-theatre-3.svg') }}"
                                            alt="Visual and Audio Communication icon" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Improvisation and Devising Theatre</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Introduction to Dramatic Territories
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Performance and Creation Lab
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/performing-arts-theatre-6.svg') }}"
