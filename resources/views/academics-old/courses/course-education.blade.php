                        ...
                        <div class="subject_listing_mainbox">
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/Education-2.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Understanding Policy and Governance of Education (Public and Private, Schools and Higher Education Institute)</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Education for The Individual and Society: Psychology, Anthropology and Sociology</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Education in Practice: School and Higher Education Institutions</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">History, Decolonisation, Language and Knowledge Politics</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
