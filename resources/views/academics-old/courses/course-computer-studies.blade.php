                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon"><img
                                            src="{{ asset('assets/images/academics/icons/web-programming.svg') }}" alt="icon"
                                            class="img-fluid"></div>
                                </div>
                            </div>
                            <div class="subject_listing">
                            ...
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon"><img
                                            src="{{ asset('assets/images/academics/icons/computer-studies-4.svg') }}" alt="icon"
                                            class="img-fluid"></div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon"><img
                                            src="{{ asset('assets/images/academics/icons/computer-studies-5.svg') }}" alt="icon"
                                            class="img-fluid"></div>
                                </div>
                            </div>
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon"><img
                                            src="{{ asset('assets/images/academics/icons/computer-studies-6.svg') }}" alt="icon"
                                            class="img-fluid"></div>
                                </div>
                            </div>
                        </div>
