...
<main class="courses_list_mainbox">
    ...
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">Law</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Legislative Processes and Administrative Law</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Criminal Justice Administration</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Law of Obligations
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Corporate Law
                                </div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
