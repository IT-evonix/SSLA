...
<main class="courses_list_mainbox">
    <section class="courses_list_section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="inner__red_heading">History</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_course_listing_mainbox">
                        ...
                        <div class="subject_listing_mainbox">
                            <div class="subject_listing">
                                ...
                                <div class="subject_listing_content_box">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-1.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Connected Worlds</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-2.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Roots of India: Prehistory to 10th Century CE</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-3.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Medieval India: 11th to 18th Century</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-4.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Modern South Asia</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-5.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">History of West Asia</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-6.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Through the Golden Gates: History of the Americas</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-7.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">African Dreams: From Colonialism to Statehood and Beyond</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-8.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">History of East Asia and Oceania</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-9.svg') }}"
                            ...
                            <div class="subject_listing">
                                <div class="subject_listing_heading">Reading the Past: Texts in History</div>
                                <div class="subject_listing_content_box">
                                    <div class="subject_listing_content">
                                        <p class="m-0">
                                    ...
                                    <div class="subject_listing_icon">
                                        <img src="{{ asset('assets/images/academics/icons/history-course-10.svg') }}"
