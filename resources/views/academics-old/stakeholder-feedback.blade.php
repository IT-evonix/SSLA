            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="new_stakeholder_mainbox" data-aos="fade-up">
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2024-25.pdf') }}" target="_blank">
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2023-24.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2022-23.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2021-22.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2020-21.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2019-2020.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2018-2019.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2017-2018.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2016-2017.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
                        ...
                        <a href="{{ asset('assets/pdf/stakeholder-feedback/Stakeholder-Feedback-2015-2016.pdf') }}" target="_blank">
                            <div class="new_stakeholder_listing">
                                <div class="new_stakeholder_list_pdf_icon">
                                    <svg width="25" height="25" x="0" y="0" viewBox="0 0 512 512">
                                        <g>
